...
//   Future<List<Coordiantes>> fetchCoordinates() async {
//     coords.clear(); // <-- امسح القديم قبل الإضافة
//     coords.clear(); // <-- امسح المسافات القديمة
...
//   Future<List<Coordiantes>> getDistance() async {
...
//       // حدّث الحقل داخل الكائن
//       element.distanceKm = formattedKm;

//       // هام: لإعلام GetX أن العنصر تغيّر نعيد تعيينه في الـ RxList
//       coords[i] = element;
//     }
